...
To get started we will load some dlf files with `read_dlf_dir`
```{r}
data_dir <- system.file("extdata", package="daisyrVis")
dlfs <- read_dlf_dir(file.path(data_dir, "annual/Annual-FN"))
...
Before plotting we need to convert the date/time columns to a timestamp using `daisy_time_to_timestamp`
```{r}
...
plot_dlf(summer95, "time", y_vars, "lines", " - Summer of '95")
```
